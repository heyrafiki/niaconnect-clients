    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white shadow rounded-lg p-6">
          <h1 className="text-xl font-bold text-gray-900 mb-6">Welcome to your Dashboard, {user.firstName}!</h1>
          <p className="text-sm text-gray-600">
            This is your client dashboard. Here you can view your upcoming appointments, access resources, track your
            progress, and connect with your support network.
          </p>
        </div>
      </main>
    </div>
