...
export default function PractitionerAuth() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isSignUp) {
      ...
      // Sign up and redirect to expert onboarding
      await signup(firstName, lastName, email, password, "expert")
    } else {
      // Login and redirect to expert dashboard
  ...
  return (
    <div className="h-screen flex overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-8">
          <div className="text-white text-center max-w-lg">
            ...
            <p className="text-base lg:text-lg opacity-90 font-secondary leading-relaxed">
              Your all-in-one platform for digital practice
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 relative flex items-center justify-center p-4 lg:p-8 h-screen overflow-y-auto">
        {/* Mobile Background with Welcome Message */}
        ...
        {/* Auth Card */}
        <div className="relative z-10 w-full max-w-md mt-0 lg:mt-0">
          ...
          <Card className="backdrop-blur-xl bg-white/80 lg:bg-white/90 border-white/30 shadow-2xl rounded-3xl border-2">
            <CardHeader className="text-center space-y-2 pb-4">
              ...
              <CardTitle className="text-lg font-bold text-gray-900">
                {isSignUp ? "Join as Practitioner" : "Practitioner Login"}
              </CardTitle>
              <CardDescription className="text-gray-600 font-secondary text-sm">
                {isSignUp ? "Create your practitioner account" : "Access your practice dashboard"}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4 px-6 pb-6">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="dr.john@clinic.com"
                    value={email}
                ...
                >
                  {isLoading ? "Processing..." : isSignUp ? "Create Practitioner Account" : "Access Dashboard"}
                </Button>
              </form>
              ...
              <div className="text-center">
                ...
                >
                  {isSignUp ? "Sign In" : "Join as Practitioner"}
                </button>
              </div>
            </CardContent>
          </Card>
